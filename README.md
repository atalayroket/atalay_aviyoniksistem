...
Teknofest Roket Yarışması için hazırlanılmıştır. Aviyonik sistemimiz 4 uçuş bilgisayarı ve 1 yer istasyonudan oluşmaktadır. Yer İstasyonumuzdan gelen veriler C# dili ile Windows Forms uygulamasında yapılan arayüzünde görüntülenmektedir.
